 <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="https://adminlte.io">Zent Group</a>.</strong> All rights
    reserved.
  </footer>
...
<script>
  $(function () {
    $('#tableDonVi').DataTable();
    $('#actionNotFilter').removeClass('sorting');
    $('#tabledoanvien').DataTable();
    $("#tabledoanvien").addClass("table-bordered");
    $('#actionNotFilter').removeClass('sorting');
    $('#tabledoanphi').DataTable();
    $("#tablePermission").DataTable();
    
    $("#tabledoanphi").addClass("table-bordered");
    $('#actionNotFilter').removeClass('sorting');
  })
</script>
<!-- SweetAlert -->
<script type="text/javascript" src="<%=request.getContextPath() %>/dist/js/sweetalert.min.js"></script>
<!-- Slimscroll -->
...
<!-- Datepicker  -->
<script src="<%=request.getContextPath() %>/dist/js/bootstrap-datetimepicker.min.js"></script>
<script src="<%=request.getContextPath() %>/dist/js/themmoidoanvien.js"></script>
<script src="<%=request.getContextPath() %>/dist/js/quanlydoanphi.js"></script>
